...
class UserProfile(AbstractUser):
    ...
    related_admin = models.ForeignKey('self', on_delete=models.CASCADE, null=True, blank=True)
    def __str__(self):
    ...
    def send_reset_password_email(self):
        ...
        smtp(
            ...
            message=f"Please click here to reset your account password 127.0.0.1:8000/users/reset_password_verify/{token}",
    ...
    def send_confirmation_email(self):
        ...
        smtp(
            ...
            message=f"Please click here to activate your account 127.0.0.1:8000/users/activate/{token}",
            recepient=self.email,
        )
    @property
    def hashed_id(self):
